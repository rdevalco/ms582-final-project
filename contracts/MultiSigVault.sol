...
// source tutorial I followed:

// https://www.codementor.io/@beber89/build-a-basic-multisig-vault-in-solidity-for-ethereum-1tisbmy6ze
// https://github.com/beber89/multisig-sample-solidity/blob/master/contracts/MulitSigVault.sol
...
contract MultiSigVault {
    ...
    function withDrawETH(WithdrawalInfo calldata _txn, uint256 _nonce, bytes[] calldata _multiSignature)
    ...
    function _verifyMultiSignature(WithdrawalInfo calldata _txn, uint256 _nonce, bytes[] calldata _multiSignature)
    private
    {
